...
$(function(){
    ...
    ajaxPost("/seimp/shareExchange/getDatalistByID", {
		...
		ajaxPost("/seimp/shareExchange/ggtfwqx/getLastUpdateTime", {
	    	ID:id
	    }).done(function (result) {
	    	if(result.status == 0){
	...
	function De2(){
		//更新表格
			...
			$('#hangyeTable').bootstrapTable({
			    method : 'POST',
			    url : "/seimp/shareExchange/ggtfwqx/getGHggtfwqxData",
			    columns : columns,
			    //search:true,
...
function De5(){
	ajaxPost("/seimp/shareExchange/ggtfwqx/getStatisDataByUpdateTime", {
...
function kepGetExcelFile(){
	...
	ajaxPost("/seimp/shareExchange/ggtfwqx/getExcelFile", parameter).done(function (result) {
		//删除等待提示框
