...
$(function(){
    ...
    ajaxPost("/seimp/shareExchange/getDatalistByID", {
		...
		ajaxPost("/seimp/shareExchange/cpqd/getLastUpdateTime", {
	    	ID:id
	    }).done(function (result) {
	    	if(result.status == 0){
	...
	function De2(){
		//更新表格
			...
			$('#hangyeTable').bootstrapTable({
			    method : 'POST',
			    url : "/seimp/shareExchange/cpqd/getCpqdData",
			    columns : columns,
			    //search:true,
...
function De5(){
	ajaxPost("/seimp/shareExchange/cpqd/getStatisDataByUpdateTime", {
...
//			DWMC : $("#DWMC").val(),
	...
	ajaxPost("/seimp/shareExchange/cpqd/getExcelFile", parameter).done(function (result) {
		//删除等待提示框
