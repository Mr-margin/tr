...
$(function(){
    ...
    ajaxPost("/seimp/shareExchange/getDatalistByID", {
		...
		ajaxPost("/seimp/shareExchange/ysxm/getLastUpdateTime", {
	    	ID:id
	    }).done(function (result) {
	    	if(result.status == 0){
	...
	function De2(){
		//更新表格
			...
			$('#hangyeTable').bootstrapTable({
			    method : 'POST',
			    url : "/seimp/shareExchange/ysxm/getYsxmData",
			    columns : columns,
			    //search:true,
...
//			    onlyInfoPagination:false,
			    queryParams: function queryParams(params) {   //设置查询参数  
			    	...
			    	var data =  JSON.stringify({
			    		...
			    		EIAMANAGENAME : $("#EIAMANAGENAME").val(),
...
function De5(){
	ajaxPost("/seimp/shareExchange/ysxm/getStatisDataByUpdateTime", {
...
function kepGetExcelFile(){
	...
	ajaxPost("/seimp/shareExchange/ysxm/getExcelFile", parameter).done(function (result) {
		//删除等待提示框
