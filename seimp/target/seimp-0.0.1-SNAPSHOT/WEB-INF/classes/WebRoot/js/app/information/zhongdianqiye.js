...
$('.zdqyB1').click(function () {
    $('.zdqyB1 img').attr('src','../../img/yghc.png')
    $('.zdqyB2 img').attr('src','../../img/dfzbB.png')
})
$('.zdqyB2').click(function () {
    $('.zdqyB1 img').attr('src','../../img/yghcB.png')
    $('.zdqyB2 img').attr('src','../../img/dfzb.png')
})
	...
	$(".xiangmuType").click(function(){
		...
		if(y==1){
			if(xiangmuType=="1"){
				...
				$('.first_input input:first').addClass('btn-danger')
				yghc();
			}else if(xiangmuType=="2"){
				$("#1").hide();
				$("#2").hide();
				...
				$('.two_input input:first').addClass('btn-danger')
				dfzb();
			}
		}
	})
...
function yghc(){
	...
	ajaxPost("/seimp/pic/getYGHCTB.do", {sheng:p,dalei:d,laiyuan:l,type:buttontypes,shi:c}).done(function (data) {
		var arr = new Array();
		var arr2 = new Array();
		var arr3 =new Array();
            ...
            for (var i = 0; i < data.data.length; i++) {
            	...
            	if(p!=""){
            		if(c2!=""){
            			...
            			if(item.SHI!=undefined&&item.SHI!=""&&item.SHI!=null&&item.SHI!=" "){
                    		arr.push(item.SHI);
                    		arr2.push(item.count);
                    		arrcode.push(item.code);
            		 }
            		...
            		if(item.SHENG!=undefined&&item.SHENG!=""&&item.SHENG!=null&&item.SHENG!=" "){
                		arr.push(item.SHENG);	
                		arr2.push(item.count);
                		arrcode.push(item.code);
            		}
